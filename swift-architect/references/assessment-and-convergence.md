...
| --- | ---: | --- |
| `BOUNDARIES` | 10 | Does the compiler enforce the allowed graph and isolation? |
...
| `PRESENTATION_QUALITY` | 7 | Is UI thin, accessible, localized, and platform-appropriate? |
| `TEST_QUALITY` | 9 | Do deterministic tests prove behavior and failure paths? |
| `PERFORMANCE_RESOURCES` | 5 | Are performance, memory, I/O, energy, and resources evidence-based? |
...
| `INTEGRATION_RECOVERY` | 3 | Are wiring, recovery, observability, and external entry paths proven? |
